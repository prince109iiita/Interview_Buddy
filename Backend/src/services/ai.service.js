...
async function generatePdfFromHtml(htmlContent) {
    if (!puppeteer) {
        throw new Error("PDF generation is not available in this environment. Puppeteer requires a server with Chrome installed and cannot run on Vercel Serverless Functions.")
    }
